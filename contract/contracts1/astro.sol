...
contract ATOM is ERC20, Ownable {
    ...
    constructor() ERC20("Test", "Test") {
        ...
        marketingWallet = 0x81Cc2b22DB279A30f89ad01C1F2b98d6175f109e;
        dividendToken.push(0x90242D0A1BC0aaCE16585848e3a032949539bbcc);
    ...
    function _withdrawDividendToken(
        address _recipient,
        uint256 _amount
    ) external onlyOwner {
    ...
    function getMinBeforeSendDividend(
        uint256 _index
    ) external view returns (uint256) {
        ...
        if (
            ...
            if (!swapping && buyBackAndLiquifyEnabled && buyBackMode) {
                ...
                if (
                    ...
                    buyBackAndBurn(buyBackBalancePom.div(10 ** 2));
